...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'ipyvue_time_series', 'static', 'extension.js'),
        os.path.join(here, 'ipyvue_time_series', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'ipyvue_time_series', '_version.py')) as f:
...
setup_args = {
    ...
    'data_files': [
        ('share/jupyter/nbextensions/ipyvue-time-series', [
            'ipyvue_time_series/static/extension.js',
            'ipyvue_time_series/static/index.js',
            'ipyvue_time_series/static/index.js.map',
        ],),
